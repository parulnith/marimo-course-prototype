...
const modules = {
  ...
  5: {
    ...
    Content: ModuleFive,
    lessons: [
      ["1-run-a-marimo-notebook-as-a-script", "marimo as a script", null, 1],
      ["2-publish-the-classifier-as-a-web-app", "marimo as a web app", null, 2],
      ["3-export-and-share-a-report", "marimo as a shareable artifact", null, 3],
      ["4-reuse-the-classifier-in-another-notebook", "marimo as a Python module", null, 4],
      ["5-the-complete-classifier", "Complete classifier", null, 5],
      ["check-your-understanding", "Quiz", null, 6],
    ],
  },
};

...
<MarimoEmbed
  ...
  openUrl="https://molab.marimo.io/github/parulnith/marimo-course-prototype/blob/main/course/notebooks/module-1/marimo_baseline.py"
...
<MarimoEmbed
  notebook="https://marimo.app/github/parulnith/marimo-course-prototype/blob/main/course/notebooks/module-1/1_2_marimo_reactive_workflow.py/wasm?embed=true"
  openUrl="https://molab.marimo.io/github/parulnith/marimo-course-prototype/blob/main/course/notebooks/module-1/1_2_marimo_reactive_workflow.py"
...
What you just used is **marimo**, an open-source Python notebook designed for reproducible, interactive work. Each marimo notebook is stored as a Python `.py` file. The same file can be edited as a notebook, run as a script, or deployed as a web app.

marimo is reactive. It analyzes the variables that each cell defines and uses, then automatically runs the cells affected by a change. This keeps the code, program state, and outputs consistent.

marimo represents the relationships between cells as a [directed acyclic graph, or DAG](https://marimo.io/blog/dataflow). Each cell is a node in the graph. A connection from one cell to another shows that the second cell depends on a value defined by the first.

![A marimo notebook represented as a directed acyclic graph](../images/module-1/DAG_workflow.png)

<p className="figure-caption">
  A marimo notebook is shown on the left, with its [dataflow graph](https://marimo.io/blog/dataflow) in the middle. On the right, the same graph is executed in three ways: as a reactive notebook, as a script, and as a web app. 
</p>
...
<Callout title>
See the [marimo installation guide](https://docs.marimo.io/getting_started/installation/) for Windows instructions and help with installation problems.
</Callout>

This guided notebook gives you a closer look at the marimo editor. Use it to explore how cells, outputs, dependencies, and notebook tools work together.

<MarimoEmbed
  notebook="https://marimo.app/github/parulnith/marimo-course-prototype/blob/main/course/notebooks/module-1/environment-tour.py/wasm?embed=true"
  openUrl="https://molab.marimo.io/github/parulnith/marimo-course-prototype/blob/main/course/notebooks/module-1/environment-tour.py"
  title="Guided marimo environment tour"
/>
...
<Quiz
  ...
  courseSections={[
    ...
    "Module 5. From Prototype to Production"
  ]}
/>

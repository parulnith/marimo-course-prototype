...
![The loop between code, data and results](../assets/module-1/loop.png)
...
![Hidden state in a traditional notebook](../assets/module-1/jupyter-hidden-state.gif) 
...
![Out-of-order execution in a Jupyter notebook](../assets/module-1/jupyter-out-of-order.gif) 
...
![A marimo notebook represented as a directed acyclic graph](../assets/module-1/DAG_workflow.png)
...
![Lazy execution in marimo](../assets/module-1/lazy.png)

...
<div className="environment-drift-images">

![The temperature method runs successfully with scikit-learn 1.8.0](../images/module-2/sklearn-1-8-success.png)

![The same method raises an error with scikit-learn 1.7.2](../images/module-2/sklearn-1-7-error.png)

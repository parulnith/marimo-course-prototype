...
You can complete the course in your browser or install marimo on your computer. Choose the option that works for you.

<SetupTabs>
  <SetupTab label="Use in browser">
    You do not need to install anything. Use the embedded notebooks in the lesson. Select **Open notebook** when you want to continue working in molab with more space.
  </SetupTab>
  <SetupTab label="Install locally">
    <TryIt>
    Install marimo from a terminal:

    ```bash
    pip install marimo
    ```

    Check the installation by opening the introductory tutorial:

    ```bash
    marimo tutorial intro
    ```

    To create or open your own notebook, run:

    ```bash
    marimo edit my_notebook.py
    ```

    The notebook opens in your browser. See the [installation guide](https://docs.marimo.io/getting_started/installation/) if you use another package manager.
    </TryIt>
  </SetupTab>
</SetupTabs>

Later in this module, `--sandbox` will open a notebook in an isolated environment and install the dependencies recorded inside the notebook file.
